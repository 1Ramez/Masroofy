 ...
 *
 * <p>
 * If no snapshot exists for the current date, the clock calculates yesterday's
 * spending and
 * persists a snapshot row that the UI can use to reflect the rollover outcome.
 * </p>
 */
public class Clock {
     ...
     *
     * @return a rollover result when a new snapshot is created, or {@code null} if
     *         no active cycle
